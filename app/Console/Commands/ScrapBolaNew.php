...
class ScrapBolaNew extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        foreach($list_portal->kanal as $kan)
        {
            ...
            if($kan->type_kanal == "Foto"){
                ...
                $this->info("Memulai Tarik Data Kanal Foto");
                ...
                if(count($title) == count($tanggal)){
                    foreach($title as $s=>$t){ 
                        ...
                        if($cek == null){
                            ...
                            $cat = \App\Models\Scrap\LinkKategori::where('portal_id',16)
                            ...
                            $sub = \App\Models\Scrap\LinkSubKategori::where('portal_id',16)
                            ...
                            //merubah format tanggal dan jam
            ...
            $this->info("Selesai Tarik Data Kanal Foto");

            }else if($kan->type_kanal == "Video"){

                $this->info("Memulai Tarik Data Kanal Video");
                    $this->info('Menarik Data yaaaa== '.$kan->url_kanal);
                ...
                $this->info("Selesai Tarik Data Kanal Video");

            }else if($kan->type_kanal == "Artikel"){
                $this->info("Memulai Tarik Data Kanal Artikel");
                if($kan->type == "indeks"){
                    $this->info('Menarik Data yaaaa== '.$kan->url_kanal);
                ...
                $this->info("Selesai Tarik Data Kanal Artikel");
            }
        }
        $this->info('Selesai');
    }
